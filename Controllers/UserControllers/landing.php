...
if(isset($_POST["Register"]))
{
	...
	$Rcheck = UserController::registration($_POST['name'],$_POST['email'], $_POST['Rpassword'] , $_POST['Rusername']  , $gender);
				...
				<div class="login-reg-bg">
					<div class="log-reg-area sign">
						...
						<form method="post" >
							...
							{
								$check=UserController::login($_POST['username'],$_POST['password']);
								if($check=="passError"){
					...
					<div class="log-reg-area reg">
						...
						<form method="post">
							...
							<div class="form-radio">
							  <div class="radio">
								<label>
								  <input type="radio" name="genderMale" checked="checked"/><i class="check-box"></i>Male
								</label>
							  </div>
							  <div class="radio">
								<label>
